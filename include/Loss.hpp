...
public:
    ...
    static double binary_cross_entropy_loss(const std::vector<double>& logits, const std::vector<double>& targets);
    static std::vector<double> binary_cross_entropy_gradient(const std::vector<double>& logits, const std::vector<double>& targets);
