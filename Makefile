...
SRCS = src/Model.cpp src/Linear.cpp src/Conv2D.cpp src/Activations.cpp src/Loss.cpp src/Utils.cpp src/MaxPool2D.cpp src/RNN.cpp src/Embedding.cpp src/SelfAttention.cpp src/CrossAttention.cpp
OBJS = $(SRCS:.cpp=.o)
